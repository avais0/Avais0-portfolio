...
export default function Home() {
  ...
  const socialLinks = [
    {
      name: "LinkedIn",
      url: "https://linkedin.com/in/avais0",
      icon: (
    ...
    {
      name: "Instagram",
      url: "https://www.instagram.com/code_with_avais?igsi=MWduOHF1NWpya2Rzbw==",
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    {
      name: "Fiverr",
      url: "https://www.fiverr.com/pe/e9lBGD",
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          <circle cx="12" cy="12" r="10" fill="none" stroke="currentColor" strokeWidth="2"/>
          <text x="12" y="16" textAnchor="middle" fontSize="11" fontWeight="bold" fill="currentColor" fontFamily="sans-serif">fi</text>
        </svg>
      )
    }
  ];
        ...
        <div className="container">
          <div className="hero-grid">
            <div className="hero-content">
              ...
              <div className="hero-social-links" style={{ marginTop: "1.8rem", display: "flex", alignItems: "center", gap: "1rem", flexWrap: "wrap" }}>
                <span style={{ fontSize: "0.9rem", color: "var(--text-secondary)", fontWeight: 500 }}>Follow Me:</span>
          ...
          <div className="contact-grid">
            <div className="contact-card-info">
              ...
              <div style={{ marginTop: "1.5rem", paddingTop: "1.5rem", borderTop: "1px solid var(--border-glass)" }}>
                <div className="contact-info-title" style={{ marginBottom: "0.8rem" }}>Connect with me</div>
                <div className="social-links" style={{ marginTop: 0 }}>
                  {socialLinks.map((s, idx) => (
                    <a
                      key={idx}
